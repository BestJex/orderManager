...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav mobileTopLevelMenus" mobile>
                <li class="layui-nav-item" data-menu="contentManagement">
                    <a href="javascript:;"><i class="seraph icon-caidan"></i><cite>后台管理系统</cite></a>
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${basePath!}/static/img/logo.png" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName"><div id="userInfoId"></div></cite></a>
                    <dl class="layui-nav-child">
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="${basePath!}/static/img/logo.png" class="userAvatar"></a>
...
layui.use(['bodyTab','form','element','layer','jquery'],function(){
    ...
    function lockPage(){
        layer.open({
            ...
            '<div class="admin-header-lock-img"><img src="${basePath!}/static/img/logo.png" class="userAvatar"/></div>'+
